...
1.  [Download and install R](https://cloud.r-project.org/). If you are using a Mac, make sure the use the correct installation, depending on whether you are using newer "M1 and higher Macs" (first option) or older "Intel Macs" (second option). You can look up the chip used in your Mac by checking out "About This Mac" under the Apple menu.
