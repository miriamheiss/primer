...
Having created models with one parameter in @sec-one-parameter, two parameters in @sec-two-parameters, three parameters in @sec-three-parameters, four parameters in @sec-four-parameters and five parameters in @sec-five-parameters, you are now ready to make the jump to $N$ parameters. 
