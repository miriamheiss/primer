...
<!-- Consider swapping out current animation to use this instead: https://github.com/jschoeley/de0anim -->
...
<!-- DK: Would be nice to make this error message print out in red. Can't find way to do this directly, but something from here might work: https://quarto.org/docs/computations/execution-options.html#raw-output. See below for my attempt. Also: -->
